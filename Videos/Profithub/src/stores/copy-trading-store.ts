...
export default class CopyTradingStore {
    ...
    async addApiToken(token: string) {
        ...
        try {
            ...
            const verification_socket = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=113831');
    ...
    async mirrorContractToConnectedAccounts(contract: any) {
        ...
        for (const account of this.connected_accounts) {
            ...
            try {
                ...
                const trade_socket = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=113831');
