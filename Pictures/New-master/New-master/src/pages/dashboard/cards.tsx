...
const Cards = observer(({ is_mobile, has_dashboard_strategies }: TCardProps) => {
    ...
    const actions: TCardArray[] = [
        ...
        {
            id: 'auto-trader',
            icon: <DerivLightMigrateStrategyIcon height='48px' width='48px' />,
            content: <Localize i18n_default_text='Auto trader' />,
            callback: () => {
                setActiveTab(DBOT_TABS.AUTO_TRADER);
            },
        },
    ];
